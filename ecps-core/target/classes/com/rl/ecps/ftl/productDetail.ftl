...
<#assign path="http://localhost:8087/ecps-protal"> 
...
$(function(){
	...
	//页面加载时候触发这个事件，调用上面的函数（ajax）
	//注意：一定要写在click事件下面才可以
	...
	<div class="r wr">
		...
		<div class="product">
			...
			<form method="post" action="" name="" class="infor">
				...
				<li><label>库　　存：</label><span class="word" id="stockState">有货</span></li>
