 ...
 * 2019-11-13T15:33:26.512+08:00
 * Generated source version: 3.2.11
 *
 */
@WebServiceClient(name = "EbWSItemServiceService",
                  wsdlLocation = "http://localhost:8087/ecps-protal/services/publishItem?wsdl",
...
public class EbWSItemServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8087/ecps-protal/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWSItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8087/ecps-protal/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
