 ...
 * 2019-11-13T15:52:46.092+08:00
 * Generated source version: 3.2.11
 *
 */
@WebServiceClient(name = "WeatherWS",
                  wsdlLocation = "file:/D:/dsworkspace/WeatherWS.wsdl",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/dsworkspace/WeatherWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/dsworkspace/WeatherWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
