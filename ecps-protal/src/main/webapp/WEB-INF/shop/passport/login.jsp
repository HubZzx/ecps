...
$(function(){
	...
	var tip=$("#tip").val();
	if(tip=="caperror"){
		$("#errorName").html("验证码输入错误");
		$("#errorName").show(500);
	}else if(tip=="userpasserror"){
		$("#errorName").html("用户名密码输入错误");
		$("#errorName").show(500);
	}
...
<div class="bar"><div class="bar_w">
	<p class="l">
		...
		<span class="l">
			...
			<a href="passport/register.html" title="免费注册">免费注册</a>
...
<div class="sign">
	...
	<div class="r">
		...
		<form id="jvForm" action="${path }/user/login.do" method="post">
			...
			<li class="alg_c dev gray">还不是移动商城会员？
				<a href="../passport/register.html" title="免费注册">免费注册</a>
			</li>
			</ul>
		</form>
...
<div id="loginAlert" class="alt login" style="display:none">
	...
	<div class="cont">
		...
		<li>
			...
			<span class="bg_text small">
				<input type="text" vld="{required:true}" maxlength="7" name="loginCaptcha" id="loginCaptcha" value="" reg1="^\w{6}$" desc="验证码不正确" />
			</span>
