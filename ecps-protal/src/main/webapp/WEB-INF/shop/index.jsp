...
<!-- 
	1.<script>中有src引用后不可以写任何代码
	2.使用<script>定义全局变量后，其下面的所有引用的js都可以使用这个全局变量
 -->
		...
		<h2 class="h2 h2_filter mt"><em title="手机商品筛选">手机&nbsp;-&nbsp;商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			...
			<ul class="uls filter">
				...
				<li><b>价格：</b><p>
					...
					<a href="javascript:void(0);" fType="price" fValue="5000-10000">5000以上</a>
				</p></li>
